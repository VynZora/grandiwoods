...
def contact(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('contact')  # redirect avoids resubmission on refresh
        else:
...
def delete_contact(request,id):
    ...
    contact.delete()
    messages.success(request,'deleted contacts succesfully.')
...
def delete_booking(request,id):
    ...
    booking.delete()
    messages.success(request,'deleted booking succesfully.')
...
def add_near_by_place(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            messages.success(request,'added place succesfully.')
...
def update_near_by_place(request, id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            messages.success(request,'update places succefully.')
            return redirect('view_near_by_place')
    else:
...
def add_folders(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            messages.success(request, "Add folders successfully!")
...
def update_folder(request, id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            messages.success(request, "update folders successfully!")
            return redirect('add_images')
    else:
...
def delete_folder(request,id):
    ...
    folder.delete()
    messages.success(request, "delete folders successfully!")
...
def update_image(request, id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.success(request, "Images update successfully!")
...
def delete_image(request,id):
    ...
    image.delete()
    messages.success(request, "delete Images successfully!")
    return redirect('view_images')
